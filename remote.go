...
func (fs *remoteFilesystem) MkdirAll(path string) error {
	return nil
}

func (fs *remoteFilesystem) Chtimes(path string, atime, mtime time.Time) error {
	return nil
}
...
func (fs *remoteFilesystem) Lock(path string) (r Releaser, existed bool, err error) {
	return virtualReleaser(func() error { return nil }), false, nil
}
...
func (f *remoteFile) SetContentType(t string) error {
	f.contentType = t
	return nil
}
